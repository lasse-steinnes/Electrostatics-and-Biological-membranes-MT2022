...
import os
import sys
sys.path.append('/home/manuela/hPF/test-BO/HyMD-2022/utils/')
...
out_h5_filename = 'lps-Re-mar-2022.h5'
out_h5_file     = os.path.join(work_folder, out_h5_filename)
in_gro_file     = os.path.join(work_folder, 'frame90ns.gro')


in_top_name = 'lpsRe.top'
