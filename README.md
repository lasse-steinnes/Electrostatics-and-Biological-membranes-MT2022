...
* Here, I develop an iterative method for solving a general Poisson equation (GPE) in the HylleraasMD ([HyMD](https://github.com/Cascella-Group-UiO/HyMD)) molecular dynamics platform. Adding this GPE framework to the HyMD platform, opens up for simulating systems with an anisotropic (spatially dependent) permittivity. In particular, anisotropic permittivity is of high relevance to biomolecular systems. 
